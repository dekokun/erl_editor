...
SocketService = function(url) {
  ...
  connected = false;
  url = url || window.location.hostname + (location.port ? ':' + location.port : '');
  init = function() {
    var ws_url;
    service = {};
    pendingCallbacks = {};
...
},{"./SocketService":1,"md2react":3,"react":172}],3:[function(require,module,exports){
...
},{"./preprocess":4,"mdast":5,"uuid":17}],4:[function(require,module,exports){
// Generated by CoffeeScript 1.9.1
(function() {
